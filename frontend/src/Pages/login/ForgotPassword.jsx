    ...
    <div className="forgot-password-page">
      ...
      <div className="forgot-password-left">
        ...
        <h2 className="hero-heading">
          ...
          <br />
          <span className="hero-heading-accent">Securely.</span>
        </h2>

        <p className="hero-description">
          We use secure verification to protect your account and keep your
          pest management services accessible anytime.
        </p>
        ...
        <div className="feature-list">
          <div className="feature-card">
            ...
            <div className="feature-text">
              ...
              <p>We verify your identity to keep your account safe.</p>
            </div>
          </div>
          ...
          <div className="feature-card">
            ...
            <div className="feature-text">
              ...
              <p>Receive reset instructions on your registered email.</p>
            </div>
          </div>
          ...
          <div className="feature-card">
            ...
            <div className="feature-text">
              ...
              <p>Your data is encrypted and kept 100% secure.</p>
            </div>
          </div>
        </div>
        ...
        <div className="floating-card">
          ...
          <p>
            Your safety is our priority. Let&apos;s continue keeping your
      ...
      <div className="forgot-password-right">
        <div className="forgot-password-card">
          ...
          <h2 className="welcome-heading">
            Forgot Your <span className="welcome-heading-accent">Password?</span>
          </h2>
