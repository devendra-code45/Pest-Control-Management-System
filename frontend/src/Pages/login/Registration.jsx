...
/* shapes since no source asset file was provided. Swap for an <img /> */
/* once you have the real illustration file.                           */
/* ------------------------------------------------------------------ */
...
/* Small decorative dot-grid, matches the pattern in the top right of
   the left panel in the reference image. */
const DotGrid = () => (
  <svg className="dot-grid" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="registration-page">
      ...
      <div className="registration-left">
        ...
        <p className="hero-description">
          Join us to manage pest control services efficiently and keep your
      ...
      <div className="registration-right">
        <div className="registration-card">
          ...
          <h2 className="welcome-heading">
            Create Your <span className="welcome-heading-accent">Account</span>
          </h2>
          <p className="welcome-subtitle">
            Register to get started with Pest Control Management System
          </p>
              ...
              <div className="form-col">
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    ...
                    <select id="pestType" defaultValue="">
                    ...
                    <HiChevronDown className="select-caret" />
                  </div>
                </div>
