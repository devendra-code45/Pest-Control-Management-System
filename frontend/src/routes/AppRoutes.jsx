...
// Complaints
import AdminComplaint from "../Pages/complaint/AdminComplaint";
import AdminComplaintView from "../Pages/complaint/AdminComplaintView";
import CustomerComplaints from "../Pages/complaint/CustomerComplaints";
import ViewComplaintDetails from "../Pages/complaint/ViewComplaintDetails";
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRole="ADMIN" />}>
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/admin/complaints/:complaintId" element={<AdminComplaintView />} />
              ...
              <Route path="/admin/payments/details" element={<PaymentDetails />} />
          ...
          <Route element={<ProtectedRoute allowedRole="CUSTOMER" />}>
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/customer/services" element={<AvailableServices />} />
              ...
              <Route path="/customer/complaints/view-details" element={<ViewComplaintDetails />} />
              <Route path="/customer/complaints/:complaintId" element={<ViewComplaintDetails />} />
